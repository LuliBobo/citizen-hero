...
import { ArrowRight, Layout, Code, Clock, PenTool, Cloud, Zap, Users, Shield, Server, Database, Bot, MessageSquare } from 'lucide-react';

const BenefitsSection = forwardRef<HTMLDivElement>((props, ref) => {
  return (
    <section ref={ref} className="py-20 bg-purple-50">
