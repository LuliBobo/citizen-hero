...
const HeroSection = () => {
  ...
  return <section id="hero-section" className="pt-32 pb-20 bg-gradient-to-b from-gray-50 to-white bg-slate-950 rounded-none py-[80px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-slate-950 py-[120px]">
